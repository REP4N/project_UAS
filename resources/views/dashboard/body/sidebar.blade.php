...
<nav class="sidenav shadow-right sidenav-light">
    <div class="sidenav-menu">
        <div class="nav accordion" id="accordionSidenav">
            ...
            <a class="nav-link {{ Request::is('pos*') ? 'active' : '' }}" href="#">
            ...
            <a class="nav-link {{ Request::is('orders/complete*') ? 'active' : '' }}" href="#">
                <div class="nav-link-icon"><i class="fa-solid fa-circle-check"></i></div>
                Complete
            </a>
            <a class="nav-link {{ Request::is('orders/pending*') ? 'active' : '' }}" href="#">
                <div class="nav-link-icon"><i class="fa-solid fa-clock"></i></div>
                Pending
            </a>
            <a class="nav-link {{ Request::is('orders/due*') ? 'active' : '' }}" href="#">
            ...
            <a class="nav-link {{ Request::is('suppliers*') ? 'active' : '' }}" href="#">
                <div class="nav-link-icon"><i class="fa-solid fa-users"></i></div>
                Suppliers
            </a>
