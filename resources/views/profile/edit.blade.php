            ...
            <div class="col-xl-4">
                ...
                <div class="card mb-4 mb-xl-0">
                    ...
                    <div class="card-body text-center">
                        ...
                        <img class="img-account-profile rounded-circle mb-2" src="{{ $user->photo ? asset('storage/profile/'.$user->photo) : asset('assets/img/illustrations/profiles/foto.jpg') }}" alt="" id="image-preview" />
